...
ARGS=(
  ...
  -s EXPORTED_FUNCTIONS="[_main, _add_js_callback, _wasm_do_seek, _malloc]"  # export main and proxy_main funcs
  ...
  -s 'ASYNCIFY_IMPORTS=[wasm_wait_readable, wasm_pause_decode]'
  -s ASYNCIFY
